...
SCENARIO_MAPPING = {
    ...
    "s5": ["dp_throughput_traces_per_sec", "ws_broadcast_latency_p95", "fastapi_ws_broadcast_latency_p95", "active_ws_clients_express", "active_ws_clients_fastapi", "pwave_aggregate_cpu_percent", "pwave_aggregate_mem_mb"],
