...
foreach ($s in $Scenarios) {
    ...
    $proc2 = Start-Process -FilePath $PythonExecutable -ArgumentList "tests/collect_metrics.py --scenario s3_archiver --duration $DurationSec --output $($s.OutMetrics)" -PassThru -NoNewWindow
