...
foreach ($s in $Scenarios) {
    ...
    $proc2 = Start-Process -FilePath $PythonExecutable -ArgumentList "tests/collect_metrics.py --scenario s3_pwave --duration $DurationSec --output $($s.OutMetrics)" -PassThru -NoNewWindow
